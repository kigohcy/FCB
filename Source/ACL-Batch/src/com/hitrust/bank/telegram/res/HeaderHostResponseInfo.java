/*
 * @(#)HeaderHostResponseInfo.java
 *
 * Copyright (c) 2016 HiTRUST Incorporated.
 * All rights reserved.
 *
 * Description:
 *		Header 下行電文 JavaBean
 *
 * Modify History:
 * v1.00, 2016/04/22, HiTRUST
 *	1) First release
 * v1.01, 2016/11/29, Ada Chen
 *  2) TSBACL-134, 1045 電文回應錯誤時, 錯誤代碼拆解錯誤
 */

package com.hitrust.bank.telegram.res;

/**
 * Header 下行電文欄位 Java Bean
 * @author HiTRUST
 */
public class HeaderHostResponseInfo extends GenericHostResponseInfo {
	...
	private String H_MSG_NO;     //Message Number
	...
	private String S_HOST_CODE;  //Host Code by Self-definition, v1.01
	...
	/**
	 * 欄位:H_MSG_TYPE(Message Type) 的 setter
	...
	/**
	 * 欄位:H_MSG_LEN(Message Length) 的 setter<br>
	 * 備註:INTERNAL Header+Output Code+Data Area總長度
	...
	/**
	 * 欄位:H_CYCL_NO(Cycle Number) 的 setter<br>
	 * 備註:"共12碼
	...
	/**
	 * 欄位:H_MSG_NO 的 getter
	 * @return H_MSG_NO Message Number
	 */
	public String getH_MSG_NO() {
		return this.H_MSG_NO;
	}
	/**
	 * 欄位:H_MSG_NO(Message Number) 的 setter<br>
	 * 備註:"共12碼
	 * @param h_MSG_NO Message Number
	 */
	...
	/**
	 * 欄位:H_SEG_NO(Segment Number) 的 setter
	...
	/**
	 * 欄位:H_FROND_NO(Front End Number) 的 setter
	...
	/**
	 * 欄位:H_TERM_NO(Terminal Number) 的 setter
	...
	/**
	 * 欄位:H_INST_NO(Institution Number) 的 setter
	...
	/**
	 * 欄位:H_BRCH_NO(Branch Number) 的 setter
	...
	/**
	 * 欄位:H_WORK_NO(Workstation Number) 的 setter
	...
	/**
	 * 欄位:H_TELR_NO(Teller Number) 的 setter<br>
	 * 備註:"74861~74880
	...
	/**
	 * 欄位:H_TXN_CODE(Transaction Code) 的 setter<br>
	 * 備註:"電文代號
	...
	/**
	 * 欄位:H_JRNL_NO(Journal Number) 的 setter<br>
	 * 備註:"主機處理序號
	...
	/**
	 * 欄位:H_TERM_TYPE(Terminal Type) 的 setter
	...
	/**
	 * 欄位:H_SUB_CHNL(Subsystem Channel) 的 setter
	...
	/**
	 * 欄位:H_SUP_ID(Supervisor ID) 的 setter
	...
	/**
	 * 欄位:H_DEBUG_FLAG(Debug Flag) 的 setter
	...
	/**
	 * 欄位:H_DEBUG_QUEU(Debug Queue) 的 setter
	...
	/**
	 * 欄位:S_HOST_CODE 的 getter
	 * @return S_HOST_CODE Host Code
	 * @since v1.01
	 */
	public String getS_HOST_CODE() {
		return this.S_HOST_CODE;
	}
	/**
	 * 欄位:S_HOST_CODE(Host Code) 的 setter
	 * @param s_HOST_CODE Host Code
	 * @since v1.01
	 */
	public void setS_HOST_CODE(String s_HOST_CODE) {
		this.S_HOST_CODE = s_HOST_CODE;
	}
}
