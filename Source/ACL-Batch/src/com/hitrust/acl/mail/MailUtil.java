...
public class MailUtil {
     ...
     */
    public static String renderMailHtmlContent(Map map, String templateId) throws Exception {
        VelocityEngine ve = new VelocityEngine();
        
//        String templatePath = APSystem.getSysDir() + AppEnv.getString("MAIL_TEMP_PATH");
        ...
        // 取得系統參數
//        String adUrl = sysParmService.getSysParmValueByParmCode("AD_URL");
//        if(StringUtils.isBlank(adUrl)){
//        	LOG.error("Failed to fetch sysParam(AD_URL)!!");
//			throw new Exception("Failed to fetch sysParam(AD_URL)!!");
//        }
               
        //V2.00, 2018/01/30 For 通知mail 日期格式調整(調成為民國年) Begin
        String year = "";
        String month = "";
        String day = "";
        ...
        context.put("EcgwUrl", AppEnv.getString("ECGW_URL"));
...
//        context.put("AdUrl", adUrl);
    ...
    public void addMail(String content, String subject, String receivers, 
        ...
        String pswdEnyrypt = AppEnv.getString("MAIL_PSWD_ENCRYPT");
        String mailPswd = AppEnv.getString("MAIL_PSWD");
        if(StringUtils.equals("Y", pswdEnyrypt)){
        	mailPswd = MAC.decryptePswd(mailPswd);
        }
        mailNotc.setMailPswd(mailPswd);
