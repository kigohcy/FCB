		...
		<div class="mainContent">
			<div class="content">
				...
				<form name="formDetl" id="formDetl" method="post" style="margin: 0;">
		         	...
		         	<div id="before" style="height: 500px; width: 485px; overflow-y: scroll; overflow-x: scroll; float: left;">
			                		...
			                		<c:choose>
								        <c:when test="${command.q_action =='E' or command.q_action =='D'}">
								        	<c:if test="${command.q_action =='D'}"> <%--刪除--%>
						                        <%@include file="F0901D_B.jsp"%>
						                    </c:if>
						                    <c:if test="${command.q_action =='E'}"> <%--變更--%>
						                        <%@include file="F0901_B.jsp"%>
						                    </c:if>
									    </c:when>
									    <c:otherwise>
		         	...
		         	&nbsp;
	           	 	<div id="after" style="height: 500px; width: 485px; overflow-y: scroll; overflow-x: scroll; float: right;">
	           	 		 <table id="datatable" class="vTable" width="980px;">
				         	 	<tr class="staffFnctTitleRow">
