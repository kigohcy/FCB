	...
	<div class="container">
		...
		<div class="mainContent">
			<div class="content">
				...
				<div id="before" style="height: 170px; width: 485px; overflow-y: scroll; overflow-x: scroll; float: left;">
					<table id="datatable1" class="vTable" width="980px">
			            ...
			            <c:choose>
					        <c:when test="${command.q_action =='E'}">
	               	...
	               	&nbsp;
	           <div id="after" style="height: 170px; width: 485px; overflow-y: scroll; overflow-x: scroll; float: right;">
