...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
		...
		<table class="fxdTable" style="width: 540px;">
			...
			<tr class="dataRowOdd" align="center">
				<c:choose>
					<c:when test="${not empty command.before.qCustId}">
						<td>${command.before.qCustId}</td>
					...
					<c:otherwise>
						<%--查無符合條件資料--%>
						<td class="noResult" colspan="3" align="center" ><fmt:message key="message.sys.NoData" /></td>
					</c:otherwise>
				</c:choose>
			</tr>
		</table>
