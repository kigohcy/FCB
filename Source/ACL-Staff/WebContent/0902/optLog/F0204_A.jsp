			...
			<c:choose>
				<c:when test="${command.before.selectEcId eq 'showCustAcnt'}">
					<table class="fxdTable" width="980px">
						...
						<c:forEach items="${command.after.optCustAcntList}" var="custAcnt" varStatus="theCount">
							<c:choose>
				...
				<c:otherwise>
					<table class="fxdTable" width="920px">
						...
						<c:forEach items="${command.after.optCustAcntLink}" var="acnt" varStatus="theCount">
							<c:choose>
								<c:when test="${theCount.count % 2 == 1}">
									<c:set value="dataRowOdd" var="cssClass"></c:set>
								</c:when>
							...
							<tr class="${cssClass}">
								...
								<td align="right">
									<c:choose>
										...
										<c:otherwise>&lt;<fmt:formatNumber type="number" pattern="###,###,###" value="${command.before.baseLimt[grad].trnsLimt}" /></c:otherwise>
									</c:choose>
								</td>
								<td align="center">
									<c:choose>
								...
								<td align="right">
									<c:choose>
										...
										<c:otherwise>&lt;<fmt:formatNumber type="number" pattern="###,###,###" value="${command.before.baseLimt[grad].dayLimt}" /></c:otherwise>
									</c:choose>
								</td>
								<td align="center">
									<c:choose>
								...
								<td align="right">
									<c:choose>
										...
										<c:otherwise>&lt;<fmt:formatNumber type="number" pattern="###,###,###" value="${command.before.baseLimt[grad].mnthLimt}" /></c:otherwise>
									</c:choose>
								</td>
								<td align="center">
									<c:choose>
