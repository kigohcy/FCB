...
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
	...
	<table class="fxdTable" width="100%">
		...
		<tr class="dataRowOdd">
			...
			<td width="150px;">
				<c:out value="${command.before.roleId}" />
				<input name="roleId" type="hidden" value="${command.before.roleId}" />
			</td>
			<td width="100x;">
			...
			<td width="150px;">
				<input name="roleName" type="text" size="40" maxlength="10" value="${command.before.roleName}" readonly />
			</td>
		</tr>
		<tr class="secondaryTitleRow">
			<td colspan="4">
	...
	<table class="staffFnctTable" width="100%">
		<c:forEach items="${command.before.staffSysMenu}" var="menu">
