...
public class FCB91970363ResponsetRule  extends GenericHostResponseRule {
	
	// Log4j
	private static Logger LOG = Logger.getLogger(FCB91970363ResponsetRule.class);
	 ...
	 */
	public FCB91970363ResponsetRule(HostRequestInfo hostRequestInfo, HostResponseInfo hostResponseInfo) {
